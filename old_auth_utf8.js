...
/* ΓòÉΓòÉΓòÉ AUTH THEME DEFAULT ΓòÉΓòÉΓòÉ */
        ...
        <View style={{ width: isWeb ? '60%' : '100%', height: isWeb ? '100%' : 'auto', flexDirection: 'column', justifyContent: 'center', position: 'relative', backgroundColor: 'transparent', pointerEvents: 'box-none' }}>
          ...
          <View style={{ position: 'relative', zIndex: 20, maxWidth: 576, paddingLeft: isWeb ? 48 : 24, paddingRight: isWeb ? 48 : 24, marginTop: isWeb ? 0 : 32 }}>
            ...
            <View style={{ flexDirection: 'row', gap: 16 }}>
              {[{ label: 'ACTIVE', value: '≡ƒæÑ 12.4K' }, { label: 'LATENCY', value: 'ΓÅ▒ 14ms' }, { label: 'PROTOCOL', value: '≡ƒöÆ AES-256' }].map(stat => (
              ...
              <View style={[{ width: '100%', borderRadius: 14, paddingHorizontal: 26, paddingVertical: 28, backgroundColor: 'rgba(15,15,26,0.85)', borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)' }, isWeb ? { backdropFilter: 'blur(16px)', boxShadow: '0 20px 40px rgba(0,0,0,0.45)' } : {}]}>
                ...
                {step === 'login' && (
                  <View>
                    ...
                    <GlassField placeholder="ΓÇóΓÇóΓÇóΓÇóΓÇóΓÇóΓÇóΓÇó" value={pass} onChangeText={setPass} secure={!showPass} icon={<Text style={{ color: '#4b5563', fontFamily: isWeb ? '"JetBrains Mono", monospace' : undefined }}>≡ƒöÆ</Text>} onSubmitEditing={handleAction} />
                    <TouchableOpacity style={{ flexDirection: 'row', alignItems: 'center', gap: 12, marginTop: 16, marginBottom: 24 }} onPress={() => setRemember(!remember)}>
                      <View style={{ width: 16, height: 16, borderRadius: 4, borderWidth: 1, borderColor: '#374151', backgroundColor: remember ? '#9333ea' : '#111827', alignItems: 'center', justifyContent: 'center' }}>{remember && <Text style={{ color: '#fff', fontSize: 10 }}>Γ£ô</Text>}</View>
                ...
                {step === 'signup' && (
                  <View>
                    ...
                    <GlassLabel>Access Key</GlassLabel>
                    <GlassField placeholder="ΓÇóΓÇóΓÇóΓÇóΓÇóΓÇóΓÇóΓÇóΓÇó" value={pass} onChangeText={setPass} secure icon={<Text style={{ color: '#4b5563', fontFamily: isWeb ? '"JetBrains Mono", monospace' : undefined }}>≡ƒöÆ</Text>} />
                    <GlassLabel>Confirm Key</GlassLabel>
                    <GlassField placeholder="ΓÇóΓÇóΓÇóΓÇóΓÇóΓÇóΓÇóΓÇóΓÇó" value={pass2} onChangeText={setPass2} secure onSubmitEditing={handleAction} icon={<Text style={{ color: '#4b5563', fontFamily: isWeb ? '"JetBrains Mono", monospace' : undefined }}>≡ƒöÆ</Text>} />
