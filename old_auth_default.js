...
/* ΓöÇΓöÇ Crosshair Icon (SVG Replacement) ΓöÇΓöÇ */
...
/* ΓöÇΓöÇ Dot-Mesh Particle Canvas (Antigravity-style) ΓöÇΓöÇ */
...
/* ΓöÇΓöÇ Corner brackets (Bento Style) ΓöÇΓöÇ */
...
/* ΓòÉΓòÉΓòÉ MAIN COMPONENT ΓòÉΓòÉΓòÉ */
export default function AuthThemeDefault(props) {
  ...
  return (
    <View style={{ width: isWeb ? '100vw' : '100%', height: isWeb ? '100vh' : '100%', flexDirection: isMobile ? 'column' : 'row', backgroundColor: '#050505', overflow: 'hidden' }}>
      ...
      {/* ΓöÇΓöÇ Dot-Mesh Particle Background ΓöÇΓöÇ */}
      <DotMeshCanvas />

      {/* ΓöÇΓöÇ Film grain overlay ΓöÇΓöÇ */}
      {isWeb && (
        <div style={{
      ...
      {/* ΓöÇΓöÇ Mouse tracking glow ΓöÇΓöÇ */}
      {isWeb && !isMobile && (
        <div style={{
      ...
      {/* ΓöÇΓöÇ Grid Elements (Static) ΓöÇΓöÇ */}
      ...
      {/* ΓöÇΓöÇ LEFT PANE: BRANDING ΓöÇΓöÇ */}
      {!isMobile && (
        <View style={{
          ...
          {/* Brain Image (Cyberpunk style ΓÇö prominent, centred-right with radial fade) */}
      ...
      {/* ΓöÇΓöÇ RIGHT PANE ΓÇö scrollable form ΓöÇΓöÇ */}
      <ScrollView
        style={[{
          width: rightPaneW,
          zIndex: 30,
            ...
            <View style={[{
              ...
              {step === 'signup' && (
                <View>
                  ...
                  {tagAvail === true && <Text style={{ color: '#10b981', fontSize: 10, fontFamily: mono, marginTop: 4, marginLeft: 4, letterSpacing: 1 }}>Γ£ô Tag available</Text>}
                  {tagAvail === false && <Text style={{ color: '#ef4444', fontSize: 10, fontFamily: mono, marginTop: 4, marginLeft: 4, letterSpacing: 1 }}>Γ£ù Tag taken</Text>}
                  ...
                  <GlassLabel>Access Key</GlassLabel>
                  <GlassField placeholder="ΓÇóΓÇóΓÇóΓÇóΓÇóΓÇóΓÇóΓÇóΓÇóΓÇóΓÇóΓÇó" value={pass} onChangeText={setPass} secure focusColor="#a855f7" icon={<Icons.LockIcon size={14} color="#64748b" />} />
                  
                  <GlassLabel>Confirm Key</GlassLabel>
                  <GlassField placeholder="ΓÇóΓÇóΓÇóΓÇóΓÇóΓÇóΓÇóΓÇóΓÇóΓÇóΓÇóΓÇó" value={pass2} onChangeText={setPass2} secure onSubmitEditing={handleAction} focusColor="#a855f7" icon={<Icons.LockIcon size={14} color="#64748b" />} />
              ...
              {/* ΓöÇΓöÇ FORGOT ΓöÇΓöÇ */}
              {step === 'forgot' && (
                <View>
                  <TouchableOpacity onPress={() => switchStep('login')} style={{ marginBottom: 32 }}>
                    <Text style={{ fontFamily: mono, color: '#00ffd0', fontSize: 11, fontWeight: '900', letterSpacing: 2 }}>{'ΓåÉ BACK TO LOGIN'}</Text>
                  </TouchableOpacity>
