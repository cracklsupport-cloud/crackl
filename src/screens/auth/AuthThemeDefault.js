                ...
                {step === 'signup' && (
                  <View>
                    ...
                    >
                      ...
                      <View style={{ flex: 1 }}>
                        <Text style={{ fontFamily: isWeb ? '"JetBrains Mono", monospace' : undefined, color: legalAccepted ? '#ddd6fe' : '#9ca3af', fontSize: 10, lineHeight: 16, textTransform: 'uppercase' }}>
                          I accept CRACKL Terms, Privacy, Fair Play, and Rewards rules.
                        </Text>
                        {openLegal && (
                          <TouchableOpacity onPress={(event) => { event?.stopPropagation?.(); openLegal(); }} style={{ alignSelf: 'flex-start', marginTop: 6 }}>
                            <Text style={{ fontFamily: isWeb ? '"JetBrains Mono", monospace' : undefined, color: '#a855f7', fontSize: 10 }}>
                    ...
                    <HoverGradientButton onPress={handleAction} disabled={loading || tagStatus === 'checking' || tagStatus === 'invalid' || tagAvail === false || !legalAccepted} loading={loading} text="REGISTER IDENTITY ->" />
                    <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center', flexWrap: 'wrap', marginTop: 40 }}>
